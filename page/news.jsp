...
<body>
    <div class="container-fluid" id="main">
        ...
        <div class="row myrow">
            ...
            <hr>
            <tag:forEach var="news1" items="<%=news%>">
                <div class="col"><a class="h6 newslist" href="${news1.src}">${news1.title}</a></div>
                <div class="col">${news1.news_date}</div>
            </tag:forEach>
        </div>
